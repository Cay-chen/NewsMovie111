...
import com.example.cay.youshi.databinding.ActivityInvalidMovieBinding;
...
public class InvalidMovieUpdateActivity extends BaseActivity<ActivityInvalidMovieBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invalid_movie);
        // showLoading();
        showContentView();
        setTitle("失效反馈");
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mEditText.getText().toString().trim().isEmpty()) {
                    Toast.makeText(InvalidMovieUpdateActivity.this, "请输入电影名或电视名", Toast.LENGTH_SHORT).show();
                } else {
                    HttpUtils.getInstance().getYouShiData(false).updateAndInvail("0",mEditText.getText().toString().trim())
                            ...
                            .subscribe(new Observer<UpDdtaBackBean>() {
                                ...
                                public void onNext(UpDdtaBackBean value) {
                                    if (value.getResMsg().equals("1")) {
                                        Toast.makeText(InvalidMovieUpdateActivity.this, "提交成功，我们将会尽快更新", Toast.LENGTH_LONG).show();
                                        mEditText.setText("");
                                    } else {
                                        Toast.makeText(InvalidMovieUpdateActivity.this, "提交失败", Toast.LENGTH_LONG).show();
    ...
    public boolean joinQQGroup(String key) {
        ...
        try {
            ...
            // 未安装手Q或安装的版本不支持
            Toast.makeText(InvalidMovieUpdateActivity.this, "未安装手Q或安装的版本不支持", Toast.LENGTH_SHORT).show();
            return false;
        }
    }
