package com.example.cay.youshi.VerUpdata;
...
public class VersionUpdateManager {
    ...
    private  void install() {
        File file = new File(savedDownloadPath, APK_NAME);
        //参数1 上下文, 参数2 Provider主机地址 和配置文件中保持一致   参数3  共享的文件
        Uri apkUri = FileProvider.getUriForFile(context, "com.example.cay.youshi", file);
